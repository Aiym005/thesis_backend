...
public class GlobalExceptionHandler {
    ...
    public ApiDtos.ApiErrorResponse handleDomainError(RuntimeException exception) {
        ...
        return new ApiDtos.ApiErrorResponse(resolveMessage(exception, "Хүсэлтийг боловсруулах үед домэйн алдаа гарлаа."));
    }
    ...
    public ApiDtos.ApiErrorResponse handleNetworkError(IOException exception) {
        ...
        return new ApiDtos.ApiErrorResponse("Дотоод service-тэй холбогдож чадсангүй. Дахин оролдоно уу.");
    }
    ...
    public ApiDtos.ApiErrorResponse handleInterrupted(InterruptedException exception) {
        ...
        return new ApiDtos.ApiErrorResponse("Service хүсэлт дундаа тасалдлаа. Дахин оролдоно уу.");
    }
    ...
    public ApiDtos.ApiErrorResponse handleUnhandledError(Exception exception) {
        ...
        return new ApiDtos.ApiErrorResponse(resolveMessage(exception, "Сервер дотоод алдаа гарлаа. Дараа дахин оролдоно уу."));
    }
